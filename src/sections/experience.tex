...
\begin{entrylist}
	\entry
		...
		{Zoi TechCon GmbH}
		{
      Oversaw engineering and dev ops of workspace transformation.

        
      \vspace{10pt}
        \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=-1pt]
            \item Implemented mail merge addon for GWS with 1000 PDF generation scale.
            \item Brought dev ops best practices to the transformation such as CI/CD.
            \item Assisted with change management and gathering of technical requirements.
        \end{itemize}
        }\\
	\entry
        {2022 - 2024}
